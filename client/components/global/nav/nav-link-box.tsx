...
const NavLinkBox: FC<NavLinkBoxProps> = ({ isMenuOpen, onClick }) => {
  ...
  return (
    <motion.div
      ...
      initial="initial"
      className="[--navlink-box-w:100vw] md:[--navlink-box-w:24rem] [--navlink-box-h:100vh] md:[--navlink-box-h:80vh] [--navlink-box-top:-16px] [--navlink-box-right:32px]  md:[--navlink-box-top:0] md:[--navlink-box-right:0] [--navlink-box-radius:0] md:[--navlink-box-radius:20px] bg-accent fixed top-4 right-8 z-20 flex flex-col justify-between"
    >
